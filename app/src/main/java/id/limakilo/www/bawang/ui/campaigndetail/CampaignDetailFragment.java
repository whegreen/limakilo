...
import id.limakilo.www.bawang.ui.campaigndetail.mvp.CampaignDetailPresenterImpl;
 ...
 */
public class CampaignDetailFragment extends Fragment implements CampaignDetailView, SwipeRefreshLayout.OnRefreshListener {
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_campaign_detail_list, container, false);
...
//        recyclerView.setAdapter(new CampaignDetailRecyclerViewAdapter(getActivity(), model.getOrderList(), presenter, model));
    }
