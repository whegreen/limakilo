...
public interface HistoryOrderView {
    ...
    public enum ViewState {
        IDLE, LOADING, LOAD_ORDERS, API_ERROR, SHOW_ORDERS, CONFIRM_ORDER, SHOW_DETAIL_ORDER, SHOW_CONFIRM_DIALOG, BLANK_STATE, LOAD_ORDER, LOAD_STOCK, SHOW_SHIPMENT_DIALOG, SHOW_DISCARD_DIALOG, SHOW_FINISH_DIALOG
    }
